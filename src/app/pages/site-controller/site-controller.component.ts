...
@Component({
  selector: 'app-site-controller',
  templateUrl: './site-controller.component.html',
  styleUrls: ['./site-controller.component.scss']
})
export class SiteControllerComponent {
  ...
  getPODetail(po_number?: any) {
    ...
    if(this.commonService.updatePurchase == true){
      ...
      po_number = this.purchaseForm.value.po_number;
    } */
